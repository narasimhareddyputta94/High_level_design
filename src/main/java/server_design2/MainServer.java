...
public class MainServer {
    ...
    public void archiveData(String key) {
        SecondLevelServer server = getServer(key);
        server.archiveData(key);
        dataStore.remove(key);
    }

    public String retrieveArchivedData(String key) {
        SecondLevelServer server = getServer(key);
        return server.retrieveArchivedData(key);
    }
    ...
    public static void main(String[] args) {
        ...
        // Archive data for some users
        mainServer.archiveData("user1");
        mainServer.archiveData("user5000");

        // Retrieve archived data
        System.out.println(mainServer.retrieveArchivedData("user1"));
        System.out.println(mainServer.retrieveArchivedData("user5000"));
